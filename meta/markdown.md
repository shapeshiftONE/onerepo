...
> Don't worry too much about memorizing or becoming a markdown pro. Most translation work will already be formatted for you beforehand. However, as much as I would like to utilize a rich text editor, markdown was deliberately chosen to maintain compatibility with Notion and GitHub. 
{.is-info}
...
![Rendering Pipeline Diagram](/diag-rendering-pipeline.webp){.radius-7 .decor-shadow}


# Markdown

> You really don't need to know the following. Just know that these functions exist.
{.is-warning}
